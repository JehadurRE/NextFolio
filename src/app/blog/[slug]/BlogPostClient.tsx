          ...
          >
            ...
            <Link href="/#blog" className="inline-block mb-8">
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
                className="inline-flex items-center space-x-2 text-secondary-600 dark:text-secondary-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors"
              >
