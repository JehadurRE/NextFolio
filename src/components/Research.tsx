...
const Research: React.FC = () => {
  ...
  const publications = [
    {
      id: 1,
      title: 'Advanced Machine Learning Approaches for Software Engineering',
      authors: ['Md. Jehadur Rahman Emran', 'Co-Author One', 'Co-Author Two'],
      venue: 'International Conference on Software Engineering',
      year: 2024,
      type: 'Conference Paper',
      abstract: 'This paper presents novel machine learning approaches for improving software engineering practices, focusing on automated code review and bug detection.',
